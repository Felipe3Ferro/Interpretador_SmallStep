...
public class Multiplicacao extends Exp {
    private Exp exp1;
    private Exp exp2;

    public Multiplicacao(Exp exp1, Exp exp2) {
        this.exp1 = exp1;
        this.exp2 = exp2;
    }
    ...
    public Exp transicao(Estado e) {
        if (!(exp1 instanceof Num)) {
            return new Multiplicacao(exp1.transicao(e), exp2);
        } else if (!(exp2 instanceof Num)) {
            return new Multiplicacao(exp1, exp2.transicao(e));
        } else {
